...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_redirects_to_all_borrowed_book_list_on_success(self):
        ...
        self.assertRedirects(resp, reverse('my-borrowed'))
...
class AuthorCreateViewTest(TestCase):
    ...
    def setUp(self):
        ...
        test_user_no_perm = User.objects.create_user(username='testuser1', password='12345')
    ...
    def test_redirects_to_author_detail_on_success(self):
        ...
        self.assertRedirects(resp, reverse('author-detail', args=[author.pk]))